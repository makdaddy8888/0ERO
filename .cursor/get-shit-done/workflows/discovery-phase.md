...
6. **Quality check:** Before finalizing findings, consult ./.cursor/get-shit-done/references/research-pitfalls.md to avoid common research gaps.

7. **Create DISCOVERY.md** using ./.cursor/get-shit-done/templates/discovery.md structure:
...
6. **Quality check:** Before finalizing findings, consult ./.cursor/get-shit-done/references/research-pitfalls.md to ensure comprehensive coverage and avoid common research gaps.
