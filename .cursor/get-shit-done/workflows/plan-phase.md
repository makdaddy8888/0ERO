...
1. ./.cursor/get-shit-done/templates/phase-prompt.md
2. ./.cursor/get-shit-done/references/plan-format.md
3. ./.cursor/get-shit-done/references/scope-estimation.md
4. ./.cursor/get-shit-done/references/checkpoints.md
5. ./.cursor/get-shit-done/references/tdd.md
...
See ./.cursor/get-shit-done/references/checkpoints.md for checkpoint structure.
</step>
...
See ./.cursor/get-shit-done/references/scope-estimation.md for complete guidance.
</step>
...
Use template from `./.cursor/get-shit-done/templates/phase-prompt.md`.
...
**TDD candidates get dedicated plans.** If "Create price calculator with discount rules" warrants TDD, create a TDD plan for it. See `./.cursor/get-shit-done/references/tdd.md` for TDD plan structure.
</task_quality>
