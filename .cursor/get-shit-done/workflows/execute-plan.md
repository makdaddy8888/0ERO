...
1. Create .planning/ISSUES.md if doesn't exist (use `./.cursor/get-shit-done/templates/issues.md`)
...
For commit message conventions, see ./.cursor/get-shit-done/references/git-integration.md
</step>
